...
{
  [Serializable]
  public class RestartGameCommand: GameCommand, ICommand
  {
    public const string COMMANDCODE = "RESTART_GAME";
    ...
    public override void Execute()
    {
      ...
      Receiver.Console.WriteLog(string.Concat("[", playerName, "] ", commandName));
      Receiver.Restart();
    }
  }
}
