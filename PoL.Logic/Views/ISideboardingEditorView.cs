...
{
  public interface ISideboardingEditorView : IView<SideboardingEditorController>
  {
    void BeginLoad();
    void EndLoad();
    void SetDeckSize(int mainSize, int sideboardSize);
    void SelectCard(SideboardingEditorListContext listContext, CardItem card);
    ...
    string GetQuickSearchText(SideboardingEditorListContext listContext);
  }
}
