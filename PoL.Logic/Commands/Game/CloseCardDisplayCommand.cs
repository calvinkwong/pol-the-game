...
{
  [Serializable]
  public class CloseCardDisplayCommand : GameCommand, ICommand
  {
    public const string COMMANDCODE = "CLOSE_DISPLAY";
    ...
    public CloseCardDisplayCommand()
      : this(null)
    {
    }
    ...
    {
      Receiver.CardDisplay.Visible.Value = false;
