namespace PoL.WinFormsView
{
  partial class StartGameMenu
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.btnSavedGame.Text = "Load a saved game. You must enter the \r\ncorresponding password.";
      this.btnSavedGame.Title = "Load a saved game";
      ...
      this.btnNewGame.Text = "Start a new game. Optionally you can \r\nset a password to enable saving feature.";
      this.btnNewGame.Title = "Start a new game";
      ...
      this.btnTitle.Text = "Start a game";
      this.btnTitle.Title = "Start game";
